  ...
  const contactInfo = [
    {
      ...
      value: 'sujithkumaravel01@gmail.com',
      icon: (
    ...
    {
      title: 'Address',
      value: '10/49, S.Thottipalayam, p.velur, Namakkal- 637213',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mt-1">
                      {info.title.toLowerCase().includes('email') ? (
                        <a
                          href={`https://mail.google.com/mail/?view=cm&to=${info.value}`}
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex justify-center space-x-4">
                <a
                  href="https://github.com/sujithk-kl"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://linkedin.com/in/sujith-kl"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
                >
